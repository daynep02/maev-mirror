 ...
 * @author Dawson Ochs
 * @brief implementations of the audio handler
 */
...
/*static*/ PyObject *AudioHandler::SetSoundPitch(PyObject *self,
                                                 PyObject *args) {
  Py_ssize_t nargs = PyTuple_GET_SIZE(args);
  if (nargs != 2) {
    printf("engine.set_sound_pitch expects a single long and a single float as "
           "arguments\n");
    PyErr_BadArgument();
  }
  PyObject *pId = PyTuple_GetItem(args, 0);
...
/*static*/ PyObject *AudioHandler::SetSoundVolume(PyObject *self,
                                                  PyObject *args) {
  Py_ssize_t nargs = PyTuple_GET_SIZE(args);
  if (nargs != 2) {
    printf("engine.set_sound_volume expects a single long and a single float "
           "as arguments\n");
    PyErr_BadArgument();
  }
  PyObject *pId = PyTuple_GetItem(args, 0);
...
/*static*/ PyObject *AudioHandler::SetSoundLoop(PyObject *self,
                                                PyObject *args) {
  Py_ssize_t nargs = PyTuple_GET_SIZE(args);
  if (nargs != 2) {
    printf("engine.set_sound_pitch expects a single long and a single bool as "
           "arguments\n");
    PyErr_BadArgument();
  }
  PyObject *pId = PyTuple_GetItem(args, 0);
...
/*static*/ PyObject *AudioHandler::SetMusicPitch(PyObject *self,
                                                 PyObject *args) {
  Py_ssize_t nargs = PyTuple_GET_SIZE(args);
  if (nargs != 2) {
    printf("engine.set_music_pitch expects a single long and a single float as "
           "arguments\n");
    PyErr_BadArgument();
  }
  PyObject *pId = PyTuple_GetItem(args, 0);
...
/*static*/ PyObject *AudioHandler::SetMusicVolume(PyObject *self,
                                                  PyObject *args) {
  Py_ssize_t nargs = PyTuple_GET_SIZE(args);
  if (nargs != 2) {
    printf("engine.set_music_volume expects a single long and a single float "
           "as arguments\n");
    PyErr_BadArgument();
  }
  PyObject *pId = PyTuple_GetItem(args, 0);
...
/*static*/ PyObject *AudioHandler::SetMusicLoop(PyObject *self,
                                                PyObject *args) {
  Py_ssize_t nargs = PyTuple_GET_SIZE(args);
  if (nargs != 2) {
    printf("engine.set_music_pitch expects a single long and a single bool as "
           "arguments\n");
    PyErr_BadArgument();
  }
  PyObject *pId = PyTuple_GetItem(args, 0);
