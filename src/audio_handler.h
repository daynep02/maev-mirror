/**
 * @file src/audio_handler.h
 * @author Dawson Ochs
 * @brief declarations file of the AudioHandler class
 */
...
public:
  /**
   * @brief constructor for the AudioHandler. Class holds only static functions,
   * so not much to do here.
   */
  AudioHandler() = default;

  /**
   *  @brief destructor for the AudioHandler class. Clears all buffers in this
   * file.
   */
  ~AudioHandler();

  /**
   * @param self necessary for python API
   * @param args Arguments from python. Should contain a single string.
   * @brief creates a sound object from the file specified in the arguments and
   * places it in a vector.
   */
...
PyDoc_STRVAR(engine_create_sound_doc,
...
PyDoc_STRVAR(engine_free_sound_doc,
             ".. function:: free_sound(id)\n"
             "\n"
             "  Frees the sound with the given id, allowing the id to be "
             "initialized to something else when calling create_sound\n"
             "\n"
             "  :return: Nothing.\n");

// corresponding documentation for engine_play_sound
PyDoc_STRVAR(engine_play_sound_doc, ".. function:: play_sound(id)\n"
                                    "\n"
...
PyDoc_STRVAR(engine_pause_sound_doc, ".. function:: pause_sound(id)\n"
                                     "\n"
...
PyDoc_STRVAR(engine_set_sound_pitch_doc,
...
PyDoc_STRVAR(engine_set_sound_volume_doc,
...
PyDoc_STRVAR(engine_set_sound_loop_doc,
...
PyDoc_STRVAR(engine_create_music_doc,
...
PyDoc_STRVAR(engine_free_music_doc,
             ".. function:: free_music(id)\n"
             "\n"
             "  Frees the music object with the given id, allowing the id to "
             "be initialized to something else when calling create_music\n"
             "\n"
             "  :return: Nothing.\n");

// corresponding documentation for engine_play_music
PyDoc_STRVAR(engine_play_music_doc, ".. function:: play_music(id)\n"
                                    "\n"
...
PyDoc_STRVAR(engine_pause_music_doc, ".. function:: pause_music(id)\n"
                                     "\n"
...
PyDoc_STRVAR(engine_set_music_pitch_doc,
...
PyDoc_STRVAR(engine_set_music_volume_doc,
...
PyDoc_STRVAR(engine_set_music_loop_doc,
