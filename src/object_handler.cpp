...
// possible bug: vectors could technically change the address of the contents, so be careful
...
ObjectHandler::ObjectHandler(sf::RenderWindow* window){
    window_ = window;
}
...
/*static*/ PyObject* ObjectHandler::SetSpritePosition(PyObject *self, PyObject *args){
    Py_ssize_t nargs = PyTuple_GET_SIZE(args);
	if (nargs != 2) {
		printf("engine.set_sprite_position expects a long and a tuple as an argument\n");
		PyErr_BadArgument();
	}
...
/*static*/ PyObject* ObjectHandler::SetSpriteScale(PyObject *self, PyObject *args){
    Py_ssize_t nargs = PyTuple_GET_SIZE(args);
	if (nargs != 2) {
		printf("engine.set_sprite_scale expects a long and a tuple as an argument\n");
		PyErr_BadArgument();
	}
    PyObject *pId = PyTuple_GetItem(args, 0);
	if (!PyLong_Check(pId)) {
...
/*static*/ PyObject* ObjectHandler::CreateCircle(PyObject *self, PyObject *args){
...
/*static*/ PyObject* ObjectHandler::SetCircleFillColor(PyObject *self, PyObject *args){
    Py_ssize_t nargs = PyTuple_GET_SIZE(args);
	if (nargs != 2) {
		printf("engine.set_circle_fill_color expects a long and a tuple as an argument\n");
		PyErr_BadArgument();
	}
    PyObject *pId = PyTuple_GetItem(args, 0);
	if (!PyLong_Check(pId)) {
...
/*static*/ PyObject* ObjectHandler::SetCirclePosition(PyObject *self, PyObject *args){
    Py_ssize_t nargs = PyTuple_GET_SIZE(args);
	if (nargs != 2) {
		printf("engine.set_circle_position expects a long and a tuple as an argument\n");
		PyErr_BadArgument();
	}
    PyObject *pId = PyTuple_GetItem(args, 0);
	if (!PyLong_Check(pId)) {
...
/*static*/ PyObject* ObjectHandler::SetCircleScale(PyObject *self, PyObject *args){
    Py_ssize_t nargs = PyTuple_GET_SIZE(args);
	if (nargs != 2) {
		printf("engine.set_circle_scale expects a long and a tuple as an argument\n");
		PyErr_BadArgument();
	}
    PyObject *pId = PyTuple_GetItem(args, 0);
	if (!PyLong_Check(pId)) {
